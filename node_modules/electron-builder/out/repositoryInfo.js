...
let _getInfo = (() => {
    var _ref2 = (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* (repo) {
        if (repo == null) {
...
function getRepositoryInfo(metadata, devMetadata) {
    if (info == null) {
        info = _getInfo((devMetadata == null ? null : devMetadata.repository) || (metadata == null ? null : metadata.repository));
    }
    return info;
}